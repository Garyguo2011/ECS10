        ...
        with open(filename) as InFile:
            for Line in InFile:
                ...
                if Elements[0] == 'First Name':
                    self.FirstName = Elements[1]
                elif Elements[0] == 'Last Name':
                    self.LastName = Elements[1]
                elif Elements[0].rfind('Phone') == len(Elements[0]) - 5:
                    #print(Elements[0],Elements[1])
                    self.SetPhoneNumber(Elements[0][:-5].strip(),Elements[1])
                elif Elements[0].rfind('Address') == len(Elements[0]) - 7:
                    #print(Elements[0],Elements[1])
                    self.SetAddress(Elements[0][:-7].strip(),Elements[1])
                elif Elements[0].rfind('E-mail') == len(Elements[0]) - 6:
                    #print(Elements[0],Elements[1])
                    self.SetEmailAddress(Elements[0][:-6].strip(),Elements[1])
                #print(Elements)
